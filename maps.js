...
enemies.set("robotBattle", robot);
    ...
    let start = 
      ...
      new Event(
         ...
         "[Head Out Of The Garage And Head Toward Ruckus]", //option 2
         "reward", // specialEvent
         null, // success
         null, // fail
         "VR1", // Event Left
      ...
      new Event(
         ...
         "[Listen To What He Has To Say]", // option 1
         "[Ignore The Stranger And Continue]", //option 2
         null, // specialEvent
         null, // success
         null, // fail
      ...
      new Event(
         ...
         "[Ask If The Mysterious Stranger Is Secretly The Long Jack]", //option 2
         null, // specialEvent
         null, // success
         null, // fail
         "tower", // Event Left
      ...
      new Event(
         ...
         "[Ask Why His Skin Is Patchy And Grey, Then]", //option 2
         null, // specialEvent
         null, // success
         null, // fail
         "tower", // Event Left
